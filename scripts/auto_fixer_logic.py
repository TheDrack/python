...
"""
    ...
    def run_with_state_machine(self, pytest_report_path: Optional[str] = None) -> int:
        ...
        while state_machine.can_attempt_repair():
            ...
            success = self._attempt_repair(issue_body, issue_id)
    ...
    def _attempt_repair(self, issue_body: str, issue_id: str) -> bool:
        """
        ...
        Returns:
            True if repair was successful (pytest passes), False otherwise
        """
        # This follows the existing logic but returns success/failure

...
def infer_intention_from_behavior(behavior):
    ...
    # Exemplo: se o comportamento for 'mover o mouse', a intenção pode ser 'interagir com a interface'
    intentions = {
        'mover o mouse': 'interagir com a interface',
        'digitar': 'criar conteúdo'
    }
